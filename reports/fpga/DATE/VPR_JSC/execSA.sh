...
SOLVERS=( "bounding_box" "criticality_timing" )
TRADEOFFS=( "0" )
...
run_one() (
  ...
  local out_file="${solver}_${base}_out.txt"
...
#../vpr  ../../vtr_flow/arch/lut6_1.xml  /home/jeronimocosta/Documentos/GIT/PeR/benchmarks/fpga/TreeLutBase/minist_tree_30_max_d_4_w_feature_4_w_tree_3_quat_False_arg_False_style_equation/minist_tree_30_max_d_4_w_feature_4_w_tree_3_quat_False_arg_False_style_equation.blif --pack -j 16 --place --route --place_algorithm bounding_box | tee treeLut_bounding_box_out.txt

#../vpr  ../../vtr_flow/arch/lut6_1.xml  /home/jeronimocosta/Documentos/GIT/PeR/benchmarks/fpga/TreeLutBase/minist_tree_30_max_d_4_w_feature_4_w_tree_3_quat_False_arg_False_style_equation/minist_tree_30_max_d_4_w_feature_4_w_tree_3_quat_False_arg_False_style_equation.blif --pack -j 16 --place --route --place_algorithm criticality_timing | tee treeLut_criticality_timing_out.txt
