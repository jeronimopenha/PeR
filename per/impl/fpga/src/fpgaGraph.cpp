...
vector<BorderInfo> FPGAGraph::getIoBordersSequence(long line, long column) {
    ...
    vector<BorderInfo> borders = {
        {abs(line - 0), BorderInfo::TOP, {column, 0}}, // top
        {abs(column - 0), BorderInfo::LEFT, {0, line}}, // left
        {abs(line - (nRows - 1)), BorderInfo::BOTTOM, {column, nRows - 1}}, // bottom
        {abs(column - (nCols - 1)), BorderInfo::RIGHT, {nCols - 1, line}} // right
    };
