...
void FPGAGraph::getGraphDataStr()
{
...
void FPGAGraph::getGraphDataInt()
{
...
vector<pair<int, int>> FPGAGraph::getEdgesDepthFirst()
{
...
vector<pair<int, int>> FPGAGraph::getEdgesZigzag(vector<pair<int, int>>& convergence)
{
...
vector<pair<int, int>> FPGAGraph::clearEdges(const vector<pair<int, int>>& edges)
{
...
void FPGAGraph::dfs(int idx, const vector<vector<int>>& adj, vector<bool>& visited, vector<int>& topo_order)
{
    visited[idx] = true;
    for (int v : adj[idx])
    {
...
unordered_map<int, int> FPGAGraph::computeLevels(const vector<int>& inputNodes, const vector<pair<int, int>>& edges)
{
