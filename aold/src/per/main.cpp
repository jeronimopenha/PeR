...
int main() {
    ...
    const std::string rootPath = getProjectRoot(); // Exemplo de função que busca o root path
    auto files = getFilesListByExtension(rootPath + "/benchmarks/fpga/bench_test/", ".dot");
