...
for file in "$input_dir"/*_k3*; do
    ...
    if [ -f "$file" ]; then
        ...
        bin/vpr "$file" "arch/k3-n1.xml" "vpr_reports/normal/${filename_no_ext}_place.txt" "vpr_reports/normal/${filename_no_ext}_route.txt" -nodisp  > "vpr_reports/normal/${filename_no_ext}.txt"
